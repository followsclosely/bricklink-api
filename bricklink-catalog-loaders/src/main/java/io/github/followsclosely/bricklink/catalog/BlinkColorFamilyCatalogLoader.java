 ...
 * <p>
 * Each record is mapped to a {@link BlinkColorDetails} DTO.
 * <p>
 * Usage: Instantiate and call {@code stream()} to process records as domain objects.
 */
@Slf4j
public class BlinkColorFamilyCatalogLoader extends AbstractCatalogLoader<BlinkColorDetails> {

    public BlinkColorFamilyCatalogLoader() {
        super("color-family.txt");
    }
