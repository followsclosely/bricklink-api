...
public interface BlinkOrderClient {
     ...
     */
    BlinkResponse<List<List<BlinkOrder.OrderItem>>> getOrderItems(Integer id);
     ...
     */
    BlinkResponse<List<BlinkOrder.Message>> getOrderMessages(Integer id);
     ...
     */
    BlinkResponse<List<BlinkOrder.Feedback>> getOrderFeedback(Integer orderId);
